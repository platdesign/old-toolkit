...
class pdform_stdElement {
	...
	static function thema($value,$required=TRUE) {
		return array(
			"type"	=>	"text",
			"name"	=>	"thema",
			"value"	=>	$value,
			"label"	=>	"Thema",
			"validation"	=>	array(
									"required"	=>	array($required,"Das Thema fehlt.")
								)
		);
	}
	
	static function title($value,$required=TRUE) {
		return array(
			"type"	=>	"text",
			"name"	=>	"title",
			"value"	=>	$value,
			"label"	=>	"Titel",
			"validation"	=>	array(
									"required"	=>	array($required,"Der Titel fehlt.")
								)
		);
	}
