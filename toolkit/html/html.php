...
class html {
	...
	private static function attr($key,$val=null) {
		if(isset($val)) {
			$val = htmlentities(utf8_decode(trim($val)));
			return(' '.$key.'="'.$val.'"');
		}
	}
	...
	public static function script($inner,$type="text/javascript") {
		$attr['type'] 	= 	$type;
		$attr['charset']=	"utf-8";
	...
	public static function header($inner=null) {
		return html::tag("header",$inner);
	}
	public static function footer($inner=null) {
		return html::tag("footer",$inner);
	}
	public static function article($inner=null) {
		return html::tag("article",$inner);
	}
	public static function aside($inner=null) {
		return html::tag("aside",$inner);
	}
	public static function section($inner=null) {
		return html::tag("section",$inner);
	}
	public static function nav($inner=null) {
		return html::tag("nav",$inner);
	}
	public static function time($inner=null) {
		return html::tag("time",$inner);
	}
